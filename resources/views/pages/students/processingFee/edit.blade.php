            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    @endif
                        ...
                        <form method="POST"  action="{{ route('processingFees.update',['processingFee'=>$processingFee->id]) }}" autocomplete="off">
                            @csrf
                            @method('patch')
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input  class="form-control text-danger font-weight-bold" readonly value="{{$processingFee->student->name}}" type="text" >
                                    </div>
                                </div>
                            </div>
                            <div class="row">
