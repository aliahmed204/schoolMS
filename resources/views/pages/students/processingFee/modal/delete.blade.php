<div class="modal fade" id="Delete_processingFees{{$processingFee->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('processingFees.destroy',['processingFee'=>$processingFee->id])}}" method="post">
                    @csrf
                    @method('delete')
