<div class="modal fade" id="Delete_processingFees{{$paymentStudent->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('paymentStudents.destroy',['paymentStudent'=>$paymentStudent->id])}}" method="post">
                    @csrf
                    @method('delete')
