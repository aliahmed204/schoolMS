<div class="modal fade" id="Graduate_Student{{$promotion->student_id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('graduated.studentSoftDelete',['student'=>$promotion->student_id])}}" method="post">
                    @csrf
                    @method('delete')
