    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel"> {{trans('Students_trans.restore')}}</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="{{route('graduated.restore',['id'=>$student->id])}}" method="post" autocomplete="off">
                    @method('patch')
                    @csrf

                    <h5 style="font-family: 'Cairo', sans-serif;">{{trans('Students_trans.Graduate_warning')}}</h5>
