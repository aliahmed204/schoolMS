                    ...
                    <div class="col-xl-12 mb-30">
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                ...
                                @endif
                                        {{--Create--}}
                                <a href="{{route('onlineClasses.create')}}" class="btn btn-success btn-sm mb-2" role="button"
                                    ...
                                    <table  class="table table-hover table-sm table-bordered p-1" data-page-length="50" style="text-align: center">
                                        ...
                                        @forelse($onlineClasses as $onlineClass)
                                            <tr>
                                                ...
                                                <td class="text-danger"><a href="{{$onlineClass->join_url}}" target="_blank"> {{trans('onlineClass.join_now')}}</a></td>
                                                <td>

                                                    {{--Delete--}}
                                                    <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                                            data-target="#delete_metting{{ $onlineClass->id }}" title="{{ __('quiz.Delete') }}">
                                            ...
                                            {{--Delete-modal--}}
                                            @include('pages.onlineClasses.modal.delete')
                                        @empty
                                            <td colspan="10"> <div class="alert alert-info" > {{ __('exam.empty')}} </div></td>
                                        @endforelse
                                    </table>
