                    ...
                    <div class="col-xl-12 mb-30">
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                ...
                                @endif
                                        {{--Create--}}
                                <a href="{{route('questions.create')}}" class="btn btn-success btn-sm mb-2" role="button"
                                    ...
                                    <table  class="table table-hover table-sm table-bordered p-1" data-page-length="50" style="text-align: center">
                                        ...
                                        @forelse($questions as $question)
                                            <tr>
                                                ...
                                                <td>
                                                    {{--Edit--}}
                                                    <a href="{{route('questions.edit',['question'=>$question->id])}}" class="btn btn-info btn-sm" role="button" aria-pressed="true">
                                            ...
                                            {{--Delete-modal--}}
                                            @include('pages.questions.modal.delete')
